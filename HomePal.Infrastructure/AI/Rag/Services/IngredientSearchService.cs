...
public class IngredientSearchService : IIngredientSearchService
{
    ...
    private readonly ILogger<IngredientSearchService> _logger;
        ...
        ILogger<IngredientSearchService> logger)
    {
        ...
        _collection = database.GetCollection<BsonDocument>(_options.IngredientsCollectionName);
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogWarning("Search query cannot be empty for ingredient vector search.");
        ...
        {
            _logger.LogError(ex, "Error occurred during ingredient vector search for query '{Query}'.", query);
            return Array.Empty<string>();
        }
    }
}
