...
public class UnitOfWork : IUnitOfWork
{
    ...
    private IMeasurementUnitRepository? _measurementUnits;
    ...
    public IMeasurementUnitRepository MeasurementUnits => _measurementUnits ??= new MeasurementUnitRepository(_context);
